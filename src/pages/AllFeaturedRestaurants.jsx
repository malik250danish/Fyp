...
import { getAllSuggestedRestaurantsMainPage, getFilteredRestaurants } from '../api/CommonApi'
...
import { addUserIdToFavoriteRestaurant, removeUserIdToFavoriteRestaurant } from '../redux/actions/HomePageActions'
...
const AllUbCategories = ({ socket }) => {
    ...
    document.title = "Featured Restaurants"
    ...
    const removeFilters = async () => {
        ...
        setFilterData({ rating: "", isDelivery: false, tags: [], isPickUp: false })
        const { data } = await getAllSuggestedRestaurantsMainPage();
        setRestaurants(data?.AllRestaurants)
    }
